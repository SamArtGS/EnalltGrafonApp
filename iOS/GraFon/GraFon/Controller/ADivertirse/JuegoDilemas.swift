...
class JuegoDilemas: UIViewController{
        
        private var score: Int = 0
        var dilema = Data.dilemas.shuffled()
        var timer: Timer?
        ...
        let mapa: UIImageView = {
            ...
            imageView.image = UIImage(named: "mapa_juego2_1")
            return imageView
        }()
        ...
        override func viewDidLoad() {
            ...
            coleccionView.register(DilemaCell.self, forCellWithReuseIdentifier: "cell_dilema")
        ...
        func terminarJuego(bool: Bool){
            ...
            alert.addAction(UIAlertAction(title: "Sí", style: .default, handler: {[weak self] _ in
                ...
                self?.dilema = Data.dilemas.shuffled()
                ...
                self?.mapa.image = UIImage(named: "mapa_juego2_1")
            }))
        ...
        func mostrarInstrucciones(){
            present(InstruccionesVC(imagenInstruccion: "tutorial_juego2_dilemas", imagenBoton: "btn_jugar_n4", juegoLanzar: .turbofon2, modal: true), animated: true)
        }
        ...
        private var fondoSonido: String = "Dilemas"
...
extension JuegoDilemas: UICollectionViewDelegate, UICollectionViewDataSource{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return dilema.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell_dilema", for: indexPath) as! DilemaCell
        cell.dilema = dilema[indexPath.item]
...
extension JuegoDilemas: UICollectionViewDelegateFlowLayout{
...
extension JuegoDilemas: juegoDilemaDelegate{
    ...
    func recolectarPuntaje(correcto: Bool) {
        ...
        if correcto{
            score += 1
            mapa.image = UIImage(named: "mapa_juego2_\(score + 1)")
        ...
        if self.score == 18{
            ...
            if indexPath.item + 1 == dilema.count{
...
extension JuegoDilemas: AVAudioPlayerDelegate{
