...
class TabBarSimbolosySonidos: UITabBarController{
    ...
    override func viewDidLoad() {
        ...
        case 1:
            break
        case 2:
            let teoria = self.crearNavegacion(titulo: "Teoría", imagenIcono: "icon-study", controller: MenuMoldeVC(collectionViewLayout: scrollLayout, puertaSeleccionada: puerta))
            ...
            break
        case 3:
            let teoría = self.crearNavegacion(titulo: "Teoría", imagenIcono: "icon-study", controller: MenuMoldeVC(collectionViewLayout: scrollLayout, puertaSeleccionada: puerta))
            let practica = self.crearNavegacion(titulo: "Práctica", imagenIcono: "icon-play", controller: PresentacionJuegoSyS())
